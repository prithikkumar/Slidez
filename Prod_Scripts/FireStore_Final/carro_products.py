...
# === Config ===
INPUT_FILE = r'C:\Users\prith\OneDrive\Desktop\Slidez\FireStorePush\FireStore_Final\Slidez_products_excel.csv'
...
async def main():
    ...
    product_ids = df['retailer_product_id'].dropna().astype(str).unique().tolist()[:MAX_PRODUCTS]
